        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.film.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="synopsis" id="synopsis" rows="4" class="form-control" required>{{ old('synopsis') }}</textarea>
                </div>

                <div class="form-group">
                    <label for="poster">Poster</label>
                    <input type="file" name="poster" id="poster" class="form-control-file" accept="image/*" required>
